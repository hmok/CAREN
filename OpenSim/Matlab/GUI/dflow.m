...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% source
folder = source; %fullfile(source,'DFLOW');%'C:\Users\mhossein\OneDrive - The University of Melbourne\Projects\TargetSearch\CB1\DFLOW';
% plotting =-1;
close all
...
for w = 1:4 %length(fileNames)%n % 3 cause the first two are ., ..
