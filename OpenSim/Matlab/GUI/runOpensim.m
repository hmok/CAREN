...
function runOpensim(dirIn,filter,cutoff,order,opensimPath,code_path)
...
%
addpath(opensimPath); % add this path for M files
% get the folder
...
num_files = 3;
for i=1:num_files%n%%[dd(1):dd(end)]%1:n%22:n
